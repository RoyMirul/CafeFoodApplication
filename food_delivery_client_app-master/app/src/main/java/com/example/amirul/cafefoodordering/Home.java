...
import com.example.amirul.cafefoodordering.Model.Banner;
import com.example.amirul.cafefoodordering.Model.Category;
import com.example.amirul.cafefoodordering.Model.Token;
import com.example.amirul.cafefoodordering.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences("com.example.amirul.cafefoodordering", MODE_PRIVATE);
